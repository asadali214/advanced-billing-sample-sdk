...
public record SegmentProperty1Value1
{
    ...
    public static SegmentProperty1Value1 Decimal(decimal value) =>
    ...
    public static implicit operator SegmentProperty1Value1(decimal value) => Decimal(value);
...
file sealed class SegmentProperty1Value1Converter : JsonConverter<SegmentProperty1Value1>
{
        ...
        JsonSerializerOptions options)
    {
        ...
        {
            return SegmentProperty1Value1.Decimal(decimalValue);
        }
