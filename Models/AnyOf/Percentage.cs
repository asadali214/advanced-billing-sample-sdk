...
public record Percentage
{
    ...
    private Percentage(Optional<string> stringValue, Optional<decimal> decimalValue)
    {
    ...
    public static Percentage Decimal(decimal value) => new(default, Optional<decimal>.Some(value));
    ...
    public static implicit operator Percentage(decimal value) => Decimal(value);
}
...
file sealed class PercentageConverter : JsonConverter<Percentage>
{
    public override Percentage Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            return Percentage.Decimal(decimalValue);
        }
