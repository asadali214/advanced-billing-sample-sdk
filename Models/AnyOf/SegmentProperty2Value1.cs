...
public record SegmentProperty2Value1
{
    ...
    public static SegmentProperty2Value1 Decimal(decimal value) =>
    ...
    public static implicit operator SegmentProperty2Value1(decimal value) => Decimal(value);
...
file sealed class SegmentProperty2Value1Converter : JsonConverter<SegmentProperty2Value1>
{
        ...
        JsonSerializerOptions options)
    {
        ...
        {
            return SegmentProperty2Value1.Decimal(decimalValue);
        }
