...
public record Quantity1
{
    ...
    private Quantity1(Optional<double> doubleValue, Optional<string> stringValue)
    {
        _doubleValue = doubleValue;
        _stringValue = stringValue;
    }

    public static Quantity1 Double(double value) => new(Optional<double>.Some(value), default);
    ...
    public static implicit operator Quantity1(double value) => Double(value);
...
file sealed class Quantity1Converter : JsonConverter<Quantity1>
{
    public override Quantity1 Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            return Quantity1.Double(doubleValue);
        }
