...
public record ExpirationYear2
{
    ...
    private ExpirationYear2(Optional<double> doubleValue, Optional<string> stringValue)
    {
        _doubleValue = doubleValue;
        _stringValue = stringValue;
    }

    public static ExpirationYear2 Double(double value) => new(Optional<double>.Some(value), default);
    ...
    public static implicit operator ExpirationYear2(double value) => Double(value);
...
file sealed class ExpirationYear2Converter : JsonConverter<ExpirationYear2>
{
        ...
        JsonSerializerOptions options)
    {
        ...
        {
            return ExpirationYear2.Double(doubleValue);
        }
