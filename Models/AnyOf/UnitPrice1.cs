...
public record UnitPrice1
{
    ...
    private UnitPrice1(Optional<string> stringValue, Optional<decimal> decimalValue)
    {
    ...
    public static UnitPrice1 Decimal(decimal value) => new(default, Optional<decimal>.Some(value));
    ...
    public static implicit operator UnitPrice1(decimal value) => Decimal(value);
}
...
file sealed class UnitPrice1Converter : JsonConverter<UnitPrice1>
{
    public override UnitPrice1 Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            return UnitPrice1.Decimal(decimalValue);
        }
