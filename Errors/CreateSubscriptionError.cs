...
public sealed class CreateSubscriptionError : ApiError
{
    ...
    private CreateSubscriptionError(Optional<ErrorListResponse1> errorListResponse1Value,
        Optional<RawError> fallback) : base(fallback)
    {
        _errorListResponse1Value = errorListResponse1Value;
    }

    private static CreateSubscriptionError AsErrorListResponse1(ErrorListResponse1 value) =>
