...
public sealed class ListAllocationsError : ApiError
{
    ...
    private ListAllocationsError(Optional<RawError> noContentValue,
    ...
    private static ListAllocationsError AsNoContent(RawError value) =>
        new(Optional<RawError>.Some(value), default, default);

    private static ListAllocationsError AsErrorListResponse1(ErrorListResponse1 value) =>
        new(default, Optional<ErrorListResponse1>.Some(value), default);

    private static ListAllocationsError AsFallback(RawError value) =>
